...
/////////////////////////////////////////////////////////////////////
/// \class MultiStepperMR MultiStepperMR.h <MultiStepperMR.h>
/// \brief Operate multiple AccelStepperMRs in a co-ordinated fashion
///
/// This class can manage multiple AccelStepperMRs (up to MULTISTEPPER_MAX_STEPPERS = 10),
...
/// All the steppers managed by MultiStepperMR will step at a constant speed to their
/// target (albeit perhaps different speeds for each stepper).
class MultiStepperMR
{
public:
    /// Constructor
    MultiStepperMR();
    ...
    boolean addStepper(AccelStepperMR& stepper);
...
private:
    ...
    AccelStepperMR* _steppers[MULTISTEPPER_MAX_STEPPERS];
...
/// @example MultiStepperMR.pde
/// Use MultiStepperMR class to manage multiple steppers and make them all move to
