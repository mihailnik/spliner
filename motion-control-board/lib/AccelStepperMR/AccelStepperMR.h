// AccelStepperMR.h
//
/// \mainpage AccelStepperMR library for Arduino
///
/// This is the Arduino AccelStepperMR library.
...
///
/// AccelStepperMR significantly improves on the standard Arduino Stepper library in several ways:
...
/// http://www.airspayce.com/mikem/arduino/AccelStepperMR
/// The version of the package that this documentation refers to can be downloaded
/// from http://www.airspayce.com/mikem/arduino/AccelStepperMR/AccelStepperMR-1.53.zip
///
...
/// with the exception that AccelStepperMR uses steps per second rather than radians per second
...
///
/// \htmlonly <form action="https://www.paypal.com/cgi-bin/webscr" method="post"><input type="hidden" name="cmd" value="_donations" /> <input type="hidden" name="business" value="mikem@airspayce.com" /> <input type="hidden" name="lc" value="AU" /> <input type="hidden" name="item_name" value="Airspayce" /> <input type="hidden" name="item_number" value="AccelStepperMR" /> <input type="hidden" name="currency_code" value="USD" /> <input type="hidden" name="bn" value="PP-DonationsBF:btn_donateCC_LG.gif:NonHosted" /> <input type="image" alt="PayPal — The safer, easier way to pay online." name="submit" src="https://www.paypalobjects.com/en_AU/i/btn/btn_donateCC_LG.gif" /> <img alt="" src="https://www.paypalobjects.com/en_AU/i/scr/pixel.gif" width="1" height="1" border="0" /></form> \endhtmlonly
///
/// \par Trademarks
///
/// AccelStepperMR is a trademark of AirSpayce Pty Ltd. The AccelStepperMR mark was first used on April 26 2010 for
...
///               specifying AccelStepperMR::FULL4WIRE and friends.
...
/// \version 1.43  Added DualMotorShield example. Shows how to use AccelStepperMR to control 2 x 2 phase steppers using the
...
///                Added new class MultiStepper that can manage multiple AccelStepperMRs,
...
///                Added new method maxSpeed() to AccelStepperMR to return the currently configured maxSpeed.<br>
...
///                AccelStepperMR::disableOutputs now sets the enable pion to OUTPUT mode if the enable pin is defined.
...
///                Improvements to efficiency of AccelStepperMR::runSpeed() as suggested by David Grayson.
...
// $Id: AccelStepperMR.h,v 1.26 2016/08/09 00:39:10 mikem Exp mikem $

#ifndef AccelStepperMR_h
#define AccelStepperMR_h
...
/////////////////////////////////////////////////////////////////////
/// \class AccelStepperMR AccelStepperMR.h <AccelStepperMR.h>
...
/// AccelStepperMR will not have a correct
...
class AccelStepperMR
{
public:
    /// \brief Symbolic names for number of pins.
    /// Use this in the pins argument the AccelStepperMR constructor to
    ...
    /// AccelStepperMR::DRIVER (1) means a stepper driver (with Step and Direction pins).
    /// If an enable line is also needed, call setEnablePin() after construction.
    /// You may also invert the pins using setPinsInverted().
    /// AccelStepperMR::FULL2WIRE (2) means a 2 wire stepper (2 pins required).
    /// AccelStepperMR::FULL3WIRE (3) means a 3 wire stepper, such as HDD spindle (3 pins required).
    /// AccelStepperMR::FULL4WIRE (4) means a 4 wire stepper (4 pins required).
    /// AccelStepperMR::HALF3WIRE (6) means a 3 wire half stepper, such as HDD spindle (3 pins required)
    /// AccelStepperMR::HALF4WIRE (8) means a 4 wire half stepper (4 pins required)
    /// Defaults to AccelStepperMR::FULL4WIRE (4) pins.
    /// \param[in] pin1 Arduino digital pin number for motor pin 1. Defaults
    /// to pin 2. For a AccelStepperMR::DRIVER (interface==1),
    /// this is the Step input to the driver. Low to high transition means to step)
    /// \param[in] pin2 Arduino digital pin number for motor pin 2. Defaults
    /// to pin 3. For a AccelStepperMR::DRIVER (interface==1),
    ...
    AccelStepperMR(uint8_t interface = AccelStepperMR::FULL4WIRE, uint8_t pin1 = 2, uint8_t pin2 = 3, uint8_t pin3 = 4, uint8_t pin4 = 5, bool enable = true);
    ...
    AccelStepperMR(void (*forward)(), void (*backward)());
...
private:
    ...
    /// The target position in steps. The AccelStepperMR library will move the
...
/// Shows how to run AccelStepperMR in the simplest,
...
/// Shows how to use AccelStepperMR to control a 3-phase motor, such as a HDD spindle motor
/// using the Adafruit Motor Shield http://www.ladyada.net/make/mshield/index.html.

/// @example DualMotorShield.pde
/// Shows how to use AccelStepperMR to control 2 x 2 phase steppers using the
