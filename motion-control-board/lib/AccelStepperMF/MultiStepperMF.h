...
#ifndef MultiStepperMF_h
#define MultiStepperMF_h
...
/////////////////////////////////////////////////////////////////////
/// \class MultiStepperMF MultiStepperMF.h <MultiStepperMF.h>
/// \brief Operate multiple AccelStepperMFs in a co-ordinated fashion
///
/// This class can manage multiple AccelStepperMFs (up to MULTISTEPPER_MAX_STEPPERS = 10),
...
/// All the steppers managed by MultiStepperMF will step at a constant speed to their
/// target (albeit perhaps different speeds for each stepper).
class MultiStepperMF
{
public:
    /// Constructor
    MultiStepperMF();
    ...
    boolean addStepper(AccelStepperMF& stepper);
...
private:
    ...
    AccelStepperMF* _steppers[MULTISTEPPER_MAX_STEPPERS];
...
/// @example MultiStepperMF.pde
/// Use MultiStepperMF class to manage multiple steppers and make them all move to
